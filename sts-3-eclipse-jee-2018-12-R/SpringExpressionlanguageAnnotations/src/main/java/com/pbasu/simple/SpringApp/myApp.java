...
public class myApp {
	...
	public static void main(String[] args) {
		...
		/* Below blocked codes will work when the beans are enabled in XML without AutoWired
		 * 
		 * 
		 * Fruit fruitNoSPEL = appContext.getBean("fruitNoSPEL",Fruit.class);
		 * System.out.println(fruitNoSPEL.talkAboutYourself());
		 * 
		 * Fruit fruitHardCodedSPEL =
		 * appContext.getBean("fruitHardCodedSPEL",Fruit.class);
		 * System.out.println(fruitHardCodedSPEL.talkAboutYourself());
		 * 
		 * Fruit fruitFromDataSourceSPEL =
		 * appContext.getBean("fruitFromDataSourceSPEL",Fruit.class);
		 * System.out.println(fruitFromDataSourceSPEL.talkAboutYourself());
		 * 
		 * Fruit fruitFromStaticDataSourceSPEL =
		 * appContext.getBean("fruitFromStaticDataSourceSPEL",Fruit.class);
		 * System.out.println(fruitFromStaticDataSourceSPEL.talkAboutYourself());
		 * 
		 * Fruit fruitFromStaticDataSourceMultiplePropertySPEL =
		 * appContext.getBean("fruitFromStaticDataSourceMultiplePropertySPEL",Fruit.
		 * class); System.out.println(fruitFromStaticDataSourceMultiplePropertySPEL.
		 * talkAboutYourself());
		 */
